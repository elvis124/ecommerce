...
$run_conatct_us = mysqli_query($db,$get_contact_us);
...
<p class="text-muted" >
you can also reach us my making a call to us 0n <b style="color: green">+254703180147</b>
</p>
...
<button type="submit" name="submit" class="btn btn-primary" style="background-color: red">
...
$msg = "I shall get back to  you soon, thanks for sending us email";
