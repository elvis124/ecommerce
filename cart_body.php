...
<input class="btn btn-primary" type="submit" style="background-color:red" name="apply_coupon" value="Apply Coupon Code" >
...
<i class="fa fa-chevron-left" style='background-color: red'></i> Continue Shopping
...
<button class="btn btn-default" type="submit" style='background-color: white' name="update" value="Update Cart">

<i class="fa fa-refresh"></i> Update Cart

</button>

<a href="checkout.php" class="btn btn-primary" style='background-color: red'>
...
<p class='price' style='background-color:black'> $product_price $product_psp_price </p>
</div>
