...
$from = "elvisianomondi@gmail.com";

$message = "

<h2>
Email Confirmation By www.mxbox.com $c_name
</h2>

<a href='localhost/secret/pages/home/home.php?$customer_confirm_code'>
...
echo "<script>alert('You have been Registered Successfully. Verify your email by the link send to your email')</script>";
...
echo "<script>alert('enter your details correctly')</script>";
