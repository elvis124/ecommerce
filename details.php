...
Product Price : <del> sh$pro_price </del><br>

Product sale Price : sh$pro_psp_price
...
Bundle Price : <del> sh$pro_price </del><br>

Bundle sale Price : sh$pro_psp_price
...
<button class="btn btn-primary" type="submit" name="add_cart" style='background-color: red'>

<i class="fa fa-shopping-cart" style='color:' ></i> Add to Cart

</button>

<button class="btn btn-primary" type="submit" name="add_wishlist" style='background-color: orange; '>

<i class="fa fa-heart" ></i> Add to Wishlist

</button>
	<p>  <div class="basket">
        <a href="cart.php" class="btn btn--basket" style="background-color:black;">
            <i class="icon-basket" style="color:yellow;"></i>
            <?php items(); ?> <b style="color:white">your busket</b>
        </a>
    </div></p>
...
<a class="btn btn-primary tab" style="margin-bottom:10px; background-color: red;" href="#description" data-toggle="tab"><!-- btn btn-primary tab Starts -->
...
<a class="btn btn-primary tab" style="margin-bottom:10px; background-color: red;" href="#features" data-toggle="tab"><!-- btn btn-primary tab Starts -->

Features

</a><!-- btn btn-primary tab Ends -->

<a class="btn btn-primary tab" style="margin-bottom:10px; background-color: red;" href="#video" data-toggle="tab"><!-- btn btn-primary tab Starts -->
...
<div id="description" class="tab-pane fade in active" style="margin-top:7px; color:black; background-color:white" ><!-- description tab-pane fade in active Starts -->

<?php echo $pro_desc; ?>

</div><!-- description tab-pane fade in active Ends -->

<div id="features" class="tab-pane fade in" style="background-color:white; color:black" style="margin-top:7px;" ><!-- features tab-pane fade in  Starts -->
...
<p class='buttons' style='padding:30px;' >
...
<p class='price' style='color:black' > $product_price $product_psp_price </p>
...
<h3><a href='$pro_url' style='color:orange'>$pro_title</a></h3>
